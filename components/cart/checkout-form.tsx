            ...
            <CardContent>
                <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <div className="space-y-2">
                            ...
                            <Input 
                                ...
                                className="rounded-xl focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400 focus:ring-offset-2 focus:border-gray-500 dark:focus:border-gray-400 text-sm sm:text-base"
                                required
                            />
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <div className="space-y-2">
                            ...
                            <Select value={selectedCountry} onValueChange={handleCountryChange}>
                                <SelectTrigger className="rounded-xl focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400 focus:ring-offset-2 focus:border-gray-500 dark:focus:border-gray-400 text-sm sm:text-base">
                                ...
                                <SelectContent className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl max-h-[300px]">
                                    {countries.map((country) => (
                                        <SelectItem key={country.isoCode} value={country.isoCode} className="text-sm sm:text-base">
                                            {country.name}
                                        </SelectItem>
                                    ))}
                                </SelectContent>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={selectedState} onValueChange={setSelectedState}>
                                ...
                                <SelectContent className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl max-h-[300px]">
                                    {states.map((state) => (
                                        <SelectItem key={state.isoCode} value={state.isoCode} className="text-sm sm:text-base">
                                            {state.name}
                                        </SelectItem>
                                    ))}
                                </SelectContent>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="zipCode" className="text-sm sm:text-base">{selectedCountry === "IN" ? "PIN Code" : "ZIP/Postal Code"}</Label>
                            <Input
                                id="zipCode"
                                name="zipCode"
                    ...
                    <Button 
                        type="submit" 
                        className="w-full h-10 sm:h-12 text-base sm:text-lg font-medium bg-black/90 hover:bg-black/70 dark:bg-white/80 dark:hover:bg-gray-100 text-white dark:text-gray-900 rounded-xl transition-colors"
